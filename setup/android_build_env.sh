...
sudo apt install lsb-release lsb-base -y
...
sudo DEBIAN_FRONTEND=noninteractive \
    ...
    libssl-dev libwxgtk3.2-dev libxml2 libxml2-utils lzop pngcrush rsync schedtool squashfs-tools xsltproc zip zlib1g-dev \
    adb autoconf automake axel bc bison build-essential \
    ccache clang cmake curl expat fastboot flex g++ 2to3 \
    g++-multilib gawk gcc gcc-multilib git git-lfs gnupg gperf \
    htop imagemagick lib32z1-dev libtinfo5 libc6-dev libcap-dev \
...
curl --create-dirs -L -o "$HOME"/.local/bin/repo -O -L https://storage.googleapis.com/git-repo-downloads/repo
